...
| [skills/local-stt-transcription](skills/local-stt-transcription/SKILL.md) | 本地视频/音频转文字稿：调用 jianchang512/stt，默认 medium + 术语校对润色，高精度 large-v3 + 校对 |
...
| `local-stt-transcription` | 本地音视频转文字稿 | `.mov` / `.mp4` / `.m4a` 等本地素材 | `content-creator` / `kangjian-skill` |
