...
更完整的流程与约束见 [skills/wiki-doc-sink/SKILL.md](skills/wiki-doc-sink/SKILL.md)。
...
| 场景 | 做法 |
|------|------|
| 本地调试 | `ln -s /path/to/ck-skills ~/.cursor/plugins/local/ck-skills`，重启 Cursor |
| 团队分发 | Dashboard → Plugins → Team Marketplaces → Import `https://github.com/chengkj99/ck-skills` |
| 公开发布 | 提交 [Cursor Marketplace](https://cursor.com/marketplace/publish) 审核后，对话中 `/add-plugin ck-skills` |
