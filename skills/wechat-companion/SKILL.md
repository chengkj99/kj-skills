...
description: >-
  为公众号文章生成完整配套物料：前言、5个标题、120字摘要、封面图提示词（2.35:1）、朋友圈和AI实战交流群转发文案。
  适用于教程指南、实战文章、技术科普等内容发布前的配套准备。
  触发词：「帮我写公众号配套」「生成配套物料」「写标题和转发文案」「公众号配套内容」「wechat-companion」，
  或 tutorial-guide 完成后用户要求生成配套时使用。
---
