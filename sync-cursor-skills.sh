#!/usr/bin/env bash
# Sync kj-skills/skills/ into Cursor user skills.
# Defaults to ~/.cursor/skills/.
...
usage() {
  cat <<'EOF'
Usage:
  ./sync-cursor-skills.sh              # link all skills
  ./sync-cursor-skills.sh <skill> ...  # link selected skills

Environment:
  CURSOR_SKILLS_DIR  Override Cursor skills directory. Defaults to ~/.cursor/skills.
EOF
}
